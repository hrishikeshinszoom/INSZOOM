package com.uiFramework.inszoom.regrationTesting.FormsLoad.pageObject.formsdDshboard;
...
public class formsDashboardPage {

	private WebDriver driver;
	private final Logger log = LoggerHelper.getLogger(formsDashboardPage.class);
	...
	public formsDashboardPage(WebDriver driver) {
		this.driver = driver;
